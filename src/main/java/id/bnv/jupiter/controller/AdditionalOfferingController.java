...
public class AdditionalOfferingController {
    ...
    public ResponseEntity getAllOfferings(@RequestHeader(value = "token") String token,
...
//    public ResponseEntity getAllInfoAboutAdditionalOfferings(@PathVariable int regionId,
